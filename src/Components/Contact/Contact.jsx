...
const Contact = () => {
  return (
    <div className='contact'>
        <h3>All correspondence to be sent to: </h3>
        <h2> THE CONVENOR, ICCISS '25</h2>
        <p>Department of Computer Science & Engineering</p>
        <p>Sona College of Technology</p>
        <p>Junction Main Road, Salem - 636 005</p>
        <div className='details1'><img src={phone_icon} alt="" /><p> : <a href="tel:+91 99420 29528">+91 99420 29528</a>,<a href="tel:98841 28486"></a> 98841 28486,<a href="tel:94430 08968"> 94430 08968</a></p></div>

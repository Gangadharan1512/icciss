    ...
    <div className="committee">
      ...
      <div className="adv-com w">
        <div className="adv">
          ...
          <p>
            Associate Professor, Department of IT, Indian Institute of
      ...
      <div className="ind adv-com">
        <div className="ind-sub">
          ...
          <h4>Lytecast, Chennai</h4>
          <h4>ES EthiSecur SofTec, Salem</h4>
        </div>
        <div className="ind-sub">
          <h4>C-RIHT, Salem</h4>
          <h4>i18nSolutions, Salem</h4>
          <h4>ImageCon, Bengaluru</h4>
        </div>
      </div>
    </div>
  );
